...
/***/ function(module, exports, __webpack_require__) {
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'h2',
						null,
						'Search For a Property (eg. quotationStart, quotationEnd)'
					),
					this.props.children
				);
			}
		...
		_createClass(SearchBox, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement('input', { type: 'text', ref: 'searchInput', placeholder: 'Search Locale property' }),
					_react2.default.createElement(
						'button',
	...
	var Search = function (_React$Component4) {
		...
		function Search() {
			...
			var _this4 = _possibleConstructorReturn(this, Object.getPrototypeOf(Search).call(this));
		...
		_createClass(Search, [{
			key: 'loadData',
			value: function loadData(property) {
				$.ajax({
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement('tbody', { dangerouslySetInnerHTML: renderTable() })
					)
				);
			}
		}]);
	...
	_reactDom2.default.render(_react2.default.createElement(
		...
		_react2.default.createElement(
			...
			_react2.default.createElement(_reactRouter.Route, { path: '/search/:property', component: Search }),
